...
| F-003 | Online foundation — websocket server + options UI | P1 | shipped | pass | pass | agent | feat/F-003-online-foundation | F-001, F-002 |
| F-004 | Proximity voice chat | P1 | dev_done | pass | pending | agent | feat/F-004-proximity-voice | F-003 |
